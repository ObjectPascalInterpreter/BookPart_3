...
function showExamplesCommand (argument : string) : boolean;
begin
   writeln ('a = 3.4; import math');
   writeln ('for i = 0 to 5 do');
   writeln ('  println (math.sqr (i)');
   writeln ('end');
   writeln ('import mat');
   writeln ('m1 = {{1,2,3},{4,5,6},{3,6,2}}');
   writeln ('m2 = mat.tr(m1)');
   exit (True);
end;
...
initialization
   ...
   listOfCommands.Add (TCommand.Create ('examples',   'Show some example code', showExamplesCommand));
