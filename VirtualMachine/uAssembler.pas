...
begin
  ...
  for i := 0 to myProgram.count - 1 do
      ...
      case myProgram.code[i].opCode of
        ...
        oPushModule : result := result + '  ' + opCodeNames[oPushModule] + ' "' + inttostr (myProgram.code[i].index) + '"' + sLineBreak;
        oPushFunction : result := result + '  ' + opCodeNames[oPushFunction] + ' "' + inttostr (myProgram.code[i].index) + '"' + sLineBreak;
