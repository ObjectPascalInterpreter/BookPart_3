...
function TTurtle.connect : boolean;
begin
   result := True;
  try
   if client = nil then
...
procedure TTurtle.goForward (d : double);
begin
   sendCmd ('fd', d);
end;
...
function TTurtle.sendCmd (cmd : string; dValue : double): TCmd;
