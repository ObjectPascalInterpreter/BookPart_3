...
type
  TBuiltInMatrix2 = class (TModuleLib)
...
constructor TBuiltInMatrix2.Create;
begin
  inherited Create ('mat', THelp.Create ('Matrix Module, deals with 2-dimensional arrays'));
...
destructor TBuiltInMatrix2.Destroy;
begin
  inherited;
end;


procedure TBuiltInMatrix2.rndu(vm: TObject);
...
procedure TBuiltInMatrix2.rndi (vm : TObject);
...
// Identity matrix
procedure TBuiltInMatrix2.ident (vm : TObject);
var n : integer;
    m : TMatrixObject;
begin
  n := TVM (vm).popInteger;
...
procedure TBuiltInMatrix2.createMatrix (vm : TObject);
var nr, nc : integer;
begin
...
procedure TBuiltInMatrix2.transpose (vm : TObject);
...
procedure TBuiltInMatrix2.add (vm : TObject);
var m1, m2 : TMatrixObject;
begin
  m2 := TVM (vm).popMatrix;
  m1 := TVM (vm).popMatrix;
...
procedure TBuiltInMatrix2.sub (vm : TObject);
var m1, m2 : TMatrixObject;
begin
  m2 := TVM (vm).popMatrix;
  m1 := TVM (vm).popMatrix;
...
procedure TBuiltInMatrix2.inverse (vm : TObject);
...
procedure TBuiltInMatrix2.LU (vm : TObject);
var
...
procedure TBuiltInMatrix2.det (vm : TObject);
var m : TMatrixObject;
    det : double;
begin
  m := TVM (vm).popMatrix;
...
procedure  TBuiltInMatrix2.solve (vm : TObject);
