...
Uses Classes, SysUtils, uModule, uListObject, uStringObject, uSymbolTable;

type
  TStackType = (stNone, stInteger, stDouble, stBoolean, stString, stList, stModule, stFunction, stObject);
